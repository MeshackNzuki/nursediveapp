<template>
    <div v-if="is_authenticated" class="bg-gradient-to-r from-blue-900 via-blue-950 to-sky-900 text-white 
        ...
        <CommonButton :button-text="subscriptionLabel(product_code)"
            :action="() => $router.push(pricingRoute(product_code))"
...
const { daysLeft, active, isTrial, pricingRoute, is_authenticated } = useAuthStore();
