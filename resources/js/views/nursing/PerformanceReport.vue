            ...
            <div
                ...
                <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-slate-500 dark:text-slate-300">Nursing exam attempt summary</p>
                    </div>
            ...
            <div v-else class="space-y-5">
                <section
                    ...
                    <div v-if="!isCompleted"
                        ...
                        <button class="ml-1 cursor-pointer font-semibold underline decoration-dashed" @click="resumeExam">
                            Resume exam
                        </button>
                    </div>
