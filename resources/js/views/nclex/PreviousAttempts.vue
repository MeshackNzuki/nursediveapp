            ...
            <template v-slot:content>
                <tr v-for="(attempt, index) in filteredAttempts" :key="index">
                    <td class="p-2 whitespace-nowrap">
                        <div class="font-semibold ps-1">{{ attempt.sub_topic_name }}</div>
                    </td>
                    <td class="p-2 whitespace-nowrap">
                    ...
                    <td class="p-2 whitespace-nowrap">
                        <div class="font-semibold ps-1">{{ Math.round(attempt.score) }}%</div>
                    </td>
                    <td>
                        <SmallButton icon="pi pi-eye" buttonText="View Report" :action="() => viewReport(attempt.id)" />
                    </td>
                    <td>
                        <SmallButton icon="pi pi-refresh" buttonText="Review Attempt"
