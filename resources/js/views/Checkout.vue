      ...
      <section class="grid gap-5 lg:grid-cols-[minmax(0,1fr)_22rem]">
        <div class="space-y-4">
          ...
          <form v-if="stripeLoaded"
            ...
            <div
              class="mb-5 flex flex-col gap-2 border-b border-slate-200 pb-4 dark:border-slate-700 sm:flex-row sm:items-center sm:justify-between">
              <div>
              ...
              <div
                class="rounded-lg bg-slate-100 px-3 py-2 text-sm font-black text-slate-900 dark:bg-slate-800 dark:text-white">
                {{ formattedAmount }}
              </div>
            </div>
        ...
        <aside
          ...
          <div
            class="mt-5 rounded-lg bg-slate-100 p-3 text-xs leading-5 text-slate-600 dark:bg-slate-800 dark:text-slate-300">
...
const productLabel = computed(() => {
  ...
  return productLabels[productCode] || "Nursenex"
})
