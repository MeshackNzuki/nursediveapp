...
<template>
    <div
        ...
        <div class="absolute inset-0 pointer-events-none -z-10">
            ...
            <div
                class="absolute top-32 right-10 h-[400px] w-[400px] bg-gradient-to-r from-emerald-200 via-cyan-200 to-sky-200 opacity-35 blur-[100px] rounded-full">
            </div>
        </div>
        ...
        <section class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto pb-10 mt-12">
            <article v-for="plan in productPlans" :key="plan.id"
                ...
                <p class="text-[11px] text-slate-500 dark:text-slate-400 mt-3 text-center">
                    Secure checkout. Immediate TEAS access.
                </p>
            </article>
        ...
        <section class="max-w-6xl mx-auto pb-16">
            <div
                ...
                <p class="text-sm text-slate-600 dark:text-slate-300">
                    TEAS learners using structured daily practice and performance review are consistently better
